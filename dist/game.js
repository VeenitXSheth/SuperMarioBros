...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  function loadAssets() {
    ...
    loadSprite("flyingbrick", "sprites/flyingbrick.png");
  ...
  scene("hidden", ({ hiddenLevelId } = { hiddenLevelId: 0 }) => {
    gravity(3200);
    const level = addLevel(HIDDENLEVELS[hiddenLevelId != null ? hiddenLevelId : 0], hiddenLevelConf);
    const player = add([
      sprite("mario"),
      pos(0, 0),
      area(),
